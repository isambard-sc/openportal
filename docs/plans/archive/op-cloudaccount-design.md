...
Status: **withdrawn**. The `op-cloudaccount` agent described below was written,
...
[project-portal-api.md](../../specifications/project-portal-api.md) for the
...
in the tree (see git history for `cloudaccount/`).
