...
pub async fn set_project_quota(
    ...
    volume: &templemeads::storage::StorageVolume,
    quota: &templemeads::storage::StorageQuota,
) -> Result<templemeads::storage::StorageQuota, Error> {
    let _lock = FS_LOCK.lock().await;

    tracing::info!(
        "set_project_quota called: project={}, volume={}, quota={}",
        mapping.project(),
        volume,
        quota
    );
    ...
    // For now, return the quota that was passed in
    Ok(quota.clone())
}
...
pub async fn get_project_quotas(
    mapping: &templemeads::grammar::ProjectMapping,
) -> Result<std::collections::HashMap<templemeads::storage::StorageVolume, templemeads::storage::StorageQuota>, Error> {
    let _lock = FS_LOCK.lock().await;

    tracing::info!(
        "get_project_quotas called: project={}",
        mapping.project()
    );
...
pub async fn set_user_quota(
    ...
    tracing::info!(
        "set_user_quota called: user={}, volume={}, quota={}",
        mapping.user(),
        volume,
        quota
    );
